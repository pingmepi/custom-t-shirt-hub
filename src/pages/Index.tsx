...
import { ArrowRight, Sparkle, Zap, Truck, Brush, Heart, Check } from "lucide-react";
            ...
            {[1, 2, 3, 4].map((item) => (
              <div key={item} className="bg-white rounded-lg shadow-sm overflow-hidden group">
                <div className="relative h-64 overflow-hidden">
                  <img 
                    src={`/tshirt-mockup-${item}.png`} 
                    alt={`T-shirt design ${item}`} 
                ...
                <div className="p-4">
                  ...
                  <div className="mt-2 flex justify-between items-center">
                    ...
                    <Button variant="ghost" size="sm" className="text-brand-green hover:text-brand-darkGreen">
